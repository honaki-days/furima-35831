class PurchaseLogAddress
  ...
  def save
    ...
    Address.create(receiver_postal_code: receiver_postal_code, user_area_id: user_area_id, receiver_cities: receiver_cities, receiver_address: receiver_address, receiver_building_name: receiver_building_name, receiver_phone_number: receiver_phone_number, purchase_log_id: purchase_log.id)
  end
end